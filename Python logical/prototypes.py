...
class PrototypeEmployee(Employee):
    def clone(self):
        return PrototypeEmployee(self.employee_id, self.name, self.phone, self.email, self.role)
    ...
    def delete_employee(self):
        ...
        # Call the delete_employee method from the Employee class or Data layer implementation
        Employee.delete_employee(self.employee_id)
...
class DishPrototype:
    def clone(self):
        ...
        clone.ingredients = self.ingredients.copy()
        return clone
